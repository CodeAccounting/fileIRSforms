...
#3th 750 records - Payer "B" Record - this Record contains the payment information from information returns.
        ...
        if (form_fields['shareholders_name'])
            returned_data += form_fields['shareholders_name'].split.last[0..3] #employees_name the first four characters of the last name
        else 
            returned_data += "    "
        end
        returned_data += "2" #Type of TIN 2 is for an individual 
...
#3th 750 records - Payer "B" Record - this Record contains the payment information from information returns.
        ...
        if (form_fields['payees_name'])
            returned_data += form_fields['payees_name'].split.last[0..3] #employees_name the first four characters of the last name
        else 
            returned_data += "    "
        end
        returned_data += "2" #Type of TIN 2 is for an individual 
...
#3th 750 records - Payer "B" Record - this Record contains the payment information from information returns.
        ...
        if (form_fields['debtors_name_XXXX'])
            returned_data += form_fields['debtors_name_XXXXX'].split.last[0..3] #employees_name the first four characters of the last name
        else 
            returned_data += "    "
        end
        returned_data += "2" #Type of TIN 2 is for an individual 
